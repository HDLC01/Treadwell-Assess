...
export const PI_PROFILES: PiProfile[] = [
  // Analytical
  {
    ...
    blurb: "Self-starting, independent risk-taker who pushes into new territory.",
    primarySlug: "pathfinder",
    note: "Independent, analytical driver — closest to our Pathfinder.",
  },
  {
    name: "Strategist",
    group: "Analytical",
...
export const ARCHETYPE_TO_PI: ArchetypeToPi[] = [
  {
    ...
    piNames: ["Maverick"],
    note: "Fast, driven, and a bit social — closest to PI's Maverick.",
  },
  ...
  { slug: "visionary", shape: "↑Dominance, reserved, fast, big-picture", piNames: ["Strategist"] },
  {
    ...
    piNames: ["Venturer"],
    note: "Independent, analytical explorer — closest to PI's Venturer.",
  },
